...
public class Chimera {
    ...
    public static void enableSandbox(){ChimeraHooks.SandboxMode=true;}
    ...
    protected static boolean validateRequest(int stackFrameDepth, Object caller){
        if (!Chimera.isCallerInitializer(1+stackFrameDepth)) {
            return false;
        }
        return caller.getClass().isAnnotationPresent(ModMain.class);
    }
    ...
    protected static boolean isCallerInitializer(int frameDepth) {
